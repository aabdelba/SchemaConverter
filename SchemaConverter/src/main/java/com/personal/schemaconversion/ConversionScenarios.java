...
public class ConversionScenarios {
	...
	public static void oldSchema_unwrapRecordFromArray(SchemaConditioner sc, Entry<String, JsonNode> oldEntry, Entry<String, JsonNode> latestEntry) {
		// TODO
		System.out.println("!!!!!!!!!!!!!!!!!!!!!!!!!!!! SCENARIO: record no longer wrapped in an array !!!!!!!!!!!!!!!!!!!!!!!!!!!!");		
	}
	
	public static void oldSchema_wrapRecordInArray(SchemaConditioner sc, Entry<String, JsonNode> oldEntry, Entry<String, JsonNode> latestEntry, JsonNode oldParent, JsonNode latestParent) throws IOException {
	...
	private static void oldJson_modifyJsonRecord(SchemaConditioner sc, String segmentName) throws IOException {
	...
	public static void latestSchema_addAliasToFieldInArray(SchemaConditioner sc, Entry<String, JsonNode> latestEntry, JsonNode oldArrayEntry, String latestPath) throws IOException {
	...
	public static void latestSchema_addAliasToFieldInSchemaArray(SchemaConditioner sc, Entry<String, JsonNode> latestEntry, Entry<String, JsonNode> oldEntry, String latestPath) throws IOException {
	...
	public static void latestSchema_addType(SchemaConditioner sc, Entry<String, JsonNode> oldEntry, Entry<String, JsonNode> latestEntry,JsonNode oldArrayEntry) {
	...
	public static void latestSchema_missingSensitiveKey(SchemaConditioner sc, Throwable e1) {
